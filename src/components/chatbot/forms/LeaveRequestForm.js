  ...
  const onFormSubmit = (e) => {
    ...
    if(!isFormHasError){
      ...
      .then(function (res) {   
        setstatus(1);
        setTimeout(() => {
          props.generateSpeech('Form has been submitted successfully')
          props.createTextMessage('Form has been submitted successfully');
    ...
    return (
     ...
     {  !isModalOpen && (<Typography component="button" variant="button" onClick={()=>props.open_modal('leaveForm')} >
      ...
      <TextField
        ...
        placeholder="Write Reason for leave here! [min 8 and max 100 char]"
        value={message}
        onInput={(e) => {
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={6}>
          ...
          > 
            ...
            <MenuItem value={"privileged leave"}>privileged leave</MenuItem> 
