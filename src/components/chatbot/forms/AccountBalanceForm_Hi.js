...
export default function AccountBalanceForm_Hi(props) {
    ...
    validateOtp(Otp, accountNo)
      .then(function (res) {
        if(res.Response == "Valid OTP") {
          ...
          setstatus(1);
          props.createTextMessage(`आपका खाता शेष है ${res.Acc_Balance}`);
          props.generateSpeech("यह आपका खाता शेष है")
          resetState();
     ...
     {  !isModalOpen && (<Typography component="button" variant="button" onClick={()=>props.open_modal('leaveForm')} >
        ...
        <div classname={classes.AccountFormWrapper}>
          <Grid container outlined spacing="1">
            <Grid item xs={8}>
              <TextField
                ...
                helperText={
                  accountNoStatus != "3" ? "" : "अमान्य खाता संख्या"
                }
                variant="standard"
            ...
            <Grid item xs={4} className={classes.bottomAlign}>
              {accountNoStatus == 2 ? 
              (<span className={classes.green} variant={accountNoStatus == 2 ? "outlined" : "contained"} color="success"  size="small">ओटीपी भेजा गया &#10003;</span>) 
              :
               ( <Button
              ...
              >
                {accountNoStatus == 2 ? "OTP Sent" : "ओटीपी भेजें"}
              </Button>)}               
            </Grid>
          </Grid>
          <Grid container spacing="1">
            <Grid item xs={6}>
              <TextField
                ...
                id="standard-error-helper-text"
                defaultValue="Hello World"
                helperText={OtpStatus != "3" ? "" : "अमान्य ओटीपी"}
                variant="standard"
                placeholder={accountNoStatus == "2" ? "ओटीपी" : "ओटीपी"}
          ...
          <Button
            ...
            align="right"
          >
            {Otp.length < 3 ? "ऊपर विवरण दर्ज करें" : "बकाया जाँचो"}
          </Button>
